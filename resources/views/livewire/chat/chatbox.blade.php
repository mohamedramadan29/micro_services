        ...
        <div class="message_headline_chatbox">
            ...
            <div class="project_details">
                @if($selectedConversation->project_id !=null)
                    ...
                    <ul>
                        <li> بخصوص :: <span> <a
                                    href="{{ url('project/' . $project['id'] . '-' . $project['slug']) }}"> {{$project_title}} </a></span>
                        </li>
                        ...
                        @if($project['user_id'] == Auth::user()->id && $project['freelancer_id'] !=null)
                            ...
                            <div class="modal fade buy_services_model" id="accept_project"
                                 tabindex="-1"
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            @else
                                                <a href="{{url('login')}}" type="button"
                                                   class="btn btn-primary"> سجل دخولك اولا  </a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
