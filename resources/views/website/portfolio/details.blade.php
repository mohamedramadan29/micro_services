...
<section class="gray-bg text-right" dir="rtl">
    <div class="container">
        <div class="main_hero_section">
            ...
            <div>
                <a class="btn btn-global-button" href="{{ url('portfolio/user/create') }}"> اضف عملك الان <i
                    ...
                    <div class="project-status">
                        ...
                        <div class="project_owner">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ url('user/'.$work->User->user_name) }}" class="btn btn-primary btn-sm"
                                    style="height: 30px">
                            ...
                            <div class="user_info">
                                <div>
                                    @if ($work['User']['image'] != '')
                                    <img src="{{ asset('assets/uploads/users_image/' . $work['User']['image']) }}">
                                    @else
                                    <img src="{{ asset('assets/website/img/favicon.png') }}" class="img-fluid rounded"
                                        alt="">
                                    @endif
                                </div>
                                <div>
