            ...
            <div class="row m-0">
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="row mobile_form">
                        <form id="uploadService" method="post" action="{{ url('service/update/' . $service['id']) }}"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group with-light">
                                                    ...
                                                    <select required class="form-control select2" name="cat_id"
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option @if ($service['cat_id'] == $category['id']) selected @endif
                                                ...
                                                <div class="form-group with-light">
                                                    ...
                                                    <select required class="form-control select2" name="sub_cat_id"
                                                        ...
                                                        @foreach ($subCategories as $subcategory)
                                                            <option @if ($service['sub_cat_id'] == $subcategory['id']) selected @endif
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="5" class="form-control with-light"
                                                        required name="price" value="{{ $service['price'] }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control with-light" required name="description">{{ $service['description'] }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12">
                                                ...
                                                <img width="100px" style="margin-top: 10px;border-radius: 5px"
                                                    src="{{ asset('assets/uploads/services/' . $service['image']) }}">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            var isSelected = (selectedSubCatId && selectedSubCatId == value
                                .id) ? 'selected' : '';
