    ...
    <section class="gray-bg text-right" dir="rtl">
        <div class="container">
            <div class="main_hero_section" style="margin-bottom: 30px">
                ...
                <div>
                    <a class="btn btn-global-button" href="{{ url('service/add') }}"> اضف خدمتك الان <i class="fa fa-plus"></i>
                    </a>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="_jb_summary light_box">
                        <div class="_jb_summary_largethumb service_details_section">
                            <img src="{{ asset('assets/uploads/services/' . $service['image']) }}" class="img-fluid"
                                alt="">
                        </div>
