                        ...
                        <div class="bredcrumb_wrap">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> اضافة عمل جديد </li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="_dashboard_content">
                                <div class="_dashboard_content_header">
                                    <div class="_dashboard__header_flex">
                                        <h4><i class="ti-briefcase mr-1"></i> اضافة عمل جديد </h4>
                                    </div>
                                </div>
                                <div class="_dashboard_content_body">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                <label for="files"> صور اضافية للعمل </label>
                                        ...
                                        <div class="col-xl-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <select required class="form-control select2" multiple name="skills[]">
                                                    ...
                                                    <option value="{{ $sub_category->id }}" {{ in_array($sub_category->
                                                        id, old('skills', [])) ? 'selected' : '' }}>
                                                        {{ $sub_category->name }}
                                                    </option>
                                                    @endforeach
                                ...
                                <button style="margin: auto;display: block" type="submit"
                                    class="btn btn-save btn-primary" id="submitBtn"> اضافة العمل <i
