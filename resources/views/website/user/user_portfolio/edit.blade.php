            ...
            <div class="row m-0">
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12">
                            ...
                            <div class="bredcrumb_wrap">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"> تعديل العمل </li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row mobile_form">
                        <form method="post"
                            action="{{ url('portfolio/user/update/' . $portfolio->id . '-' . $portfolio->slug) }}"
                                ...
                                <div class="_dashboard_content">
                                    <div class="_dashboard_content_header">
                                        <div class="_dashboard__header_flex">
                                            <h4><i class="ti-briefcase mr-1"></i> تعديل العمل </h4>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control with-light" name="title"
                                                        required value="{{ old('title', $portfolio->title) }}">
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    <label> قم بوصف المشروع </label>
                                                    <textarea class="form-control with-light" required name="description">{{ old('description', $portfolio->description) }}</textarea>
                                                </div>
                                            </div>
                                            <div>
                                                    ...
                                                    <select required class="form-control form-select" name="category">
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                {{ old('category', $portfolio->category_id) == $category->id ? 'selected' : '' }}>
                                                                {{ $category->name }}
                                                            </option>
                                                        @endforeach
                                            ...
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control with-light" name="link"
                                                        required value="{{ old('link', $portfolio->link) }}">
                                                </div>
                                            </div>
                                    ...
                                    <button style="margin: auto;display: block" type="submit"
                                        class="btn btn-save btn-primary" id="submitBtn"> تعديل العمل <i
