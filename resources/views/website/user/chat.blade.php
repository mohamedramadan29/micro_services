                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="messages-container margin-top-0">
                                <div class="messages-headline">
                                    ...
                                    <a href="#" class="message-action"><i class="ti-trash"></i> Delete
                                        Conversation</a>
                                </div>
                                ...
                                <div class="messages-container-inner">
                                    ...
                                    <div class="dash-msg-inbox">
                                        <ul>
                                            <li>
                                                <a href="#">
                                                    <div class="dash-msg-avatar"><img
                                                            ...
                                                            alt=""><span class="_user_status online"></span></div>
                                            ...
                                            <li class="active-message">
                                                <a href="#">
                                                    <div class="dash-msg-avatar"><img
                                                            src="{{ asset('assets/website/img/team-2.jpg') }}"
                                                            alt=""><span class="_user_status offline"></span></div>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="dash-msg-avatar"><img
                                                            src="{{ asset('assets/website/img/team-2.jpg') }}"
                                                            alt=""><span class="_user_status busy"></span></div>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="dash-msg-avatar"><img
                                                            src="{{ asset('assets/website/img/team-2.jpg') }}"
                                                            alt=""><span class="_user_status offline"></span>
                                                    </div>
                                    ...
                                    <div class="dash-msg-content">
                                        <div class="message-plunch">
                                            <div class="dash-msg-avatar"><img
                                                    src="{{ asset('assets/website/img/team-2.jpg') }}" alt="">
                                            </div>
                                            <div class="dash-msg-text">
                                                <p>Hello, Contrary to popular belief, Lorem Ipsum
                                        ...
                                        <div class="message-plunch me">
                                            <div class="dash-msg-avatar"><img
                                                    src="{{ asset('assets/website/img/team-3.jpg') }}" alt="">
                                            </div>
                                            <div class="dash-msg-text">
                                                <p>looked up one of the more obscure Latin words,
                                                    consectetur, from a Lorem</p>
                                            </div>
                                        </div>
                                        <!-- Reply Area -->
