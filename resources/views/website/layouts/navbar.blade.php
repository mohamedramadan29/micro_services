                        ...
                        <ul class="nav-menu nav-menu-social">
                            ...
                            <div class="dropdown notificaion-alerts">
                                <button class="dropdown-toggle" type="button" id="dropdownMenuButton1"
                                    ...
                                    'App\Notifications\NewMessage')->count() > 0)
                                    <span class="counter"> {{ Auth::user()->unreadNotifications->count() }}
                                    </span>
                                    @endif
                                    <li><a href=""> <i style="font-size: 20px" class="bi bi-envelope-fill"></i> </a>
                                    </li>
                                </button>
                            ...
                            <div class="dropdown notificaion-alerts">
                                <button class="dropdown-toggle" type="button" id="dropdownMenuButton1"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    @php
                                    $unreadNotificationsUsers =
                                    \Illuminate\Support\Facades\Auth::user()->unreadNotifications->filter(
                            ...
                            <div class="dropdown profile-dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    {{-- <li><a class="dropdown-item" href="{{ url('reviews') }}"><i
                                                class="ti-email"></i> التقيمات </a></li> --}}
