                                ...
                                <div class="panel-heading" id="pay">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" role="button" data-parent="#payaccordion"
                                           ...
                                           class="">PayPal<img src="assets/img/paypal.png" class="img-fluid" alt=""></a>
                                    </h4>
                                </div>
                                <div id="payPal" class="panel-collapse collapse show" aria-labelledby="pay"
                                    ...
                                    <div class="panel-body">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn dark-2 btm-md full-width">Pay 400.00
                                                    USD
                                                </button>
                                            </div>
                                        </form>
                                ...
                                <div class="panel-heading" id="dabit">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" role="button" href="#payaccordion"
                                           data-target="#debitPay" aria-expanded="flase" aria-controls="debitPay"
                                           class="">Debit Or Credit<img src="assets/img/debit.png" class="img-fluid"
                                                                        alt=""></a>
                                    </h4>
                                </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        <input id="ct-2" class="checkbox-custom" name="ct-2"
                                                               type="checkbox">
                                                        <label for="ct-2" class="checkbox-custom-label">By Continuing,
