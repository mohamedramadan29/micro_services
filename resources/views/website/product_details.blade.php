                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="_jb_summary light_box">
                        ...
                        <div class="_view_dis_908 price_section">
                            <ul class="exlio_list">
                                <li> السعر <span
                                        style="color: #3fb699"> {{ number_format($product['price'],2)}} $</span>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            @if(Auth::check())
                                                <form style="width: 100%" method="post" action="{{url('product_order')}}">
                                                    <div class="form-group">
                                                        <label> الدولة  </label>
                                                        <input style="height: 45px" class="form-control" name="country" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>  المدينة   </label>
                                                        <input style="height: 45px" class="form-control" name="city" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>  العنوان بشكل  تفصيلي  </label>
                                                        <input style="height: 45px" class="form-control" name="address" required>
                                                    </div>
                                                    <div class="form-group">
