            ...
            <div class="row m-0">
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12">
                            ...
                            <div class="bredcrumb_wrap">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"> تعديل الوظيفة </li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row mobile_form">
                        <form method="post" action="{{ url('my/job/update/'.$job->id) }}" enctype="multipart/form-data"
                            id="uploadService">
                            @csrf
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <!-- Single Wrap -->
                                <div class="_dashboard_content">
                                    <div class="_dashboard_content_header">
                                        <div class="_dashboard__header_flex">
                                            <h4><i class="ti-briefcase mr-1"></i> تعديل بيانات الوظيفة </h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control with-light" name="title"
                                                        required value="{{ old('title',$job['title']) }}">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="category_id" class="form-select" id="">
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option @selected(old('category_id',$job['category_id']) == $category['id'])
                                            ...
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control with-light" required name="description">{{ old('description',$job['description']) }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control with-light" name="experience">{{ old('experience',$job['experience']) }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <select required name="sex" class="form-select" id="">
                                                        ...
                                                        <option @selected(old('sex',$job['sex']) == 'ذكر') value="ذكر">ذكر</option>
                                                        <option @selected(old('sex',$job['sex']) == 'انثى') value="انثى">انثى</option>
                                                        <option @selected(old('sex',$job['sex']) == 'غير محدد') value="غير محدد">غير محدد</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control with-light" name="city"
                                                        required value="{{ old('city',$job['city']) }}">
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control with-light" name="country"
                                                        required value="{{ old('country',$job['country']) }}">
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control with-light" name="address"
                                                        required value="{{ old('address',$job['address']) }}">
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    <label>  الراتب <span class="badge badge-danger"> $ </span> </label>
                                                    <input type="number" step="0.01" class="form-control with-light" name="salary"
                                                        required value="{{ old('salary',$job['salary']) }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
