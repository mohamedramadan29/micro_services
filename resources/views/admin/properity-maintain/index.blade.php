        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <div class="mb-4 main-content-label"> خدمات الصيانة </div>
                    <div class="card-body">
                            ...
                            <table class="table text-md-nowrap" id="example2">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-15p border-bottom-0"> العقد   </th>
                                ...
                                <tbody>
                                    @foreach ($properities as $properity)
                                        <tr>
                                            ...
                                            <td> {{ $properity->contract_type }} </td>
                                            <td> {{ $properity->location }} </td>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    ...
                                                    <form action="{{ url('admin/properity-maintain/active/' . $properity['id']) }}"
                                                        method="POST">
                                                        @csrf
                                            ...
                                            <td>
                                                <a href="{{ url('admin/properity-maintain/update/' . $properity['id']) }}"
                                        ...
                                        @include('admin.properity-maintain._delete')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
