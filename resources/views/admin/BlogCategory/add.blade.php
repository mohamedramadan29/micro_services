                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <select required class="form-control" id="status" data-choices
                                                ...
                                                <option @selected(old('status') == 0) value="0"> ارشيف </option>
                                                <option @selected(old('status') == 1) value="1"> نشط </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="meta_url" class="form-control" name="meta_url"
                                                placeholder="أدخل رابط القسم" value="{{ old('meta_url') }}">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="meta_description" rows="7" name="meta_description"
                                                placeholder="وصف صفحة القسم">{{ old('meta_description') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="mb-3">
