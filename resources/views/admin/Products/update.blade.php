        ...
        <form method="post" action="{{ url('admin/product/update/' . $product->slug) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-8 ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="short_description" class="form-label"> وصف مختصر عن
                                            المنتج </label>
                                        <textarea class="form-control bg-light-subtle" id="short_description" rows="5"
                                            placeholder=""
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea required class="form-control bg-light-subtle tinymce" id="description"
                                            rows="7" placeholder=""
                    ...
                    <div class="card" id="digital-file-section"
                        style="display: {{ $product->type === 'digital' ? 'block' : 'none' }};">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="alert alert-info mb-4">
                                        ...
                                        <a href="{{ asset('assets/uploads/digital_products/' . $product->digital_file) }}"
                                            target="_blank" class="btn btn-primary btn-sm ms-2">
                                            <i class="bx bx-download"></i> عرض / تنزيل الملف
                                        </a>
                                        <br><small class="text-muted">سيتم استبدال هذا الملف إذا قمت برفع ملف
                                            جديد.</small>
                                    </div>
                                    @endif

                                    <!-- Livewire Component للرفع الجديد -->
                                    @livewire('digital-file-upload', ['currentFile' => $product->digital_file])
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input step="0.01" type="number" id="price" name="price" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control bg-light-subtle" id="meta_description" rows="7"
                                            placeholder=""
            ...
            <div class="card-body">
                ...
                <div class="video-container" style="margin-top: 20px;">
                    <video controls width="400"
                        ...
                        <source src="{{ asset('assets/uploads/product_videos/' . $product->video) }}" type="video/mp4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img width="80px" class="img-thumbnail img-prod"
                                    src="{{ asset('assets/uploads/product_gallery/' . $gallary->image) }}" alt=""></td>
                            <td>
                                <button data-target="#delete_gallary_{{ $gallary->id }}" data-toggle="modal"
