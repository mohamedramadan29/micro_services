        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">إضافة قالب جديد</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">يمكنك استخدام متغيرات مثل: <code>@{{name}}</code> <code>@{{company}}</code></small>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">يمكنك استخدام متغيرات مثل: <code>@{{name}}</code> <code>@{{email}}</code> <code>@{{unsubscribe_url}}</code></small>
