        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/   الاستشارين    </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <div class="mb-4 main-content-label">   الاستشارين     </div>
                    <div class="card-header">
                        <a href="{{url('admin/consultant/add')}}" class="btn btn-primary btn-sm "> اضافة استشاري  جديد  </a>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table text-md-nowrap" id="example2">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">  التحصص  </th>
                                ...
                                @foreach($consults as $consult)
                                    <tr>
                                        <td> {{$i++}} </td>
                                        <td> {{$consult['name']}} </td>
                                        <td> {{$consult['category']['name']}} </td>
                                        <td> {{$consult['email']}} </td>
                                        <td><img width="60px" height="60px" src="{{asset('assets/uploads/consultants/'.$consult['image'])}}" alt=""> </td>
                                        <td> @if($consult['is_active'] == 1)
                                        ...
                                        <td>
                                            <a href="{{url('admin/consultant/update/'.$consult['id'])}}" class="btn btn-primary btn-sm">  تعديل <i class="fa fa-edit"></i> </a>
                                            <button data-target="#delete_model_{{$consult['id']}}"
                                                    data-toggle="modal" class="btn btn-danger btn-sm"> حذف <i
                                                    class="fa fa-trash"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    @include('admin.consultants.delete')
                                @endforeach
                                </tbody>
                            </table>
                        </div>
