        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <div class="mb-4 main-content-label"> تفاصيل العقار </div>
                    <form class="form-horizontal" method="post"
                        action="{{ url('admin/properity/update/' . $properity->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input disabled readonly required type="number" class="form-control"
                                                name="price" value="{{ $properity->bathrooms }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            @php
                                                $features = explode(',', $properity->features);
...
@endforeach
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input disabled readonly required type="text" step="0.01"
                                                class="form-control" name="price" value="{{ $properity->status }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
