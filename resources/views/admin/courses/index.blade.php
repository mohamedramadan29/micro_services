                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/course/update/' . $course['id']) }}"
                                            class="btn btn-primary btn-sm"> تفاصيل الكورس <i class="fa fa-edit"></i>
                                        </a>

                                        <a href="{{ url('admin/course/user_register/' . $course['id']) }}"
                                            class="btn btn-warning btn-sm"> مشاهدة المشتركين <i class="fa fa-edit"></i>
                                        </a>
                                        <button data-target="#delete_model_{{ $course['id'] }}" data-toggle="modal"
