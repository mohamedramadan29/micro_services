    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                تفاصيل المشتركين في الكورس </span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <div class="mb-4 main-content-label"> تفاصيل المشتركين في الكورس ( {{ $course->title }} ) </div>
                <div class="card-body">
                        ...
                        <table class="table text-md-nowrap" id="example2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0"> توقيت الاشتراك </th>
