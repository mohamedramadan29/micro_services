...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل البيانات </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="{{url('admin/update_admin_details')}}"
                        ...
                        <div class="form-group ">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input readonly type="text" class="form-control" value="{{$admin_data['account_type']}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group ">
