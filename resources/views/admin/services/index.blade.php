        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/   الخدمات  </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <div class="mb-4 main-content-label">   الخدمات   </div>
                            ...
                            <table class="table text-md-nowrap" id="example2">
                                ...
                                @foreach($services as $service)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('admin/service/update/'.$service['id'])}}" class="btn btn-primary btn-sm">  تعديل <i class="fa fa-edit"></i> </a>
                                            <button data-target="#delete_model_{{$service['id']}}"
