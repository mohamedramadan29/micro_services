                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-12">
                                        <div class="mb-3">
                                            ...
                                            <select required class="form-control" id="status" data-choices
                                                ...
                                                <option value=""> -- حدد حالة المقال --</option>
                                    ...
                                    <div class="mt-2 col-lg-12">
                                        <div class="mb-3">
                                            <label for="desc" class="form-label"> محتوي المقال <span class="star"
                                                    style="color: red"> * </span></label>
                                            <textarea class="form-control bg-light-subtle tinymce" id="desc" rows="7" placeholder="" name="desc">{{ old('desc') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
