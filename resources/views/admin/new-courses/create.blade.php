    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.new-courses.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="image">صورة الكورس <span class="text-danger">*</span></label>
                                <input type="file" class="form-control" id="image" name="image" accept="image/*" required>
                                <small class="text-muted">الحجم الموصى به: 800x600 بكسل</small>

                                @if(old('image'))
                                    <div class="mt-2">
                                        <img src="{{ asset(old('image')) }}" alt="صورة الكورس" style="max-width: 100%; height: auto;">
                                    </div>
                                @endif
                            </div>
